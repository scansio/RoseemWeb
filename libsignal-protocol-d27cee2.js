!function() {
    ...
    s = "object" == typeof A && "object" == typeof A.versions && "string" == typeof A.versions.node,
    f = !o && !s && !I;
    var a, h, B, C, E = "";
    function u(A) {
        return r.locateFile ? r.locateFile(A, E) : E + A
    }
    s ? (E = I ? require("path").dirname(E) + "/" : __dirname + "/",
    a = function(A, e) {
        var t = oA(A);
        return t ? e ? t : t.toString() : (B || (B = require("fs")),
        C || (C = require("path")),
        A = C.normalize(A),
        B.readFileSync(A, e ? null : "utf8"))
    }
    ,
    h = function(A) {
        var e = a(A, !0);
    ...
    ,
    A.argv.length > 1 && A.argv[1].replace(/\\/g, "/"),
    g = A.argv.slice(2),
    ...
    h = function(A) {
        var e;
        return (e = oA(A)) ? e : "function" == typeof readbuffer ? new Uint8Array(readbuffer(A)) : (d("object" == typeof (e = read(A, "binary"))),
        e)
    }
    ,
    "undefined" != typeof scriptArgs ? g = scriptArgs : void 0 !== arguments && (g = arguments),
    "undefined" != typeof print && ("undefined" == typeof console && (console = {}),
    console.log = print,
    console.warn = console.error = "undefined" != typeof printErr ? printErr : print)) : (o || I) && (I ? E = self.location.href : document.currentScript && (E = document.currentScript.src),
    ...
    function _() {
        ...
        r.instantiateWasm)
            try {
                ...
                return l("Module.instantiateWasm callback failed with error: " + A),
                !1
            }
        return function() {
            if (Q || "function" != typeof WebAssembly.instantiateStreaming || W(j) || V(j) || "function" != typeof fetch)
                return i(t);
            fetch(j, {
                credentials: "same-origin"
            }).then((function(e) {
                return WebAssembly.instantiateStreaming(e, A).then(t, (function(A) {
                    return l("wasm streaming compile failed: " + A),
    ...
    function rA(A) {
        for (var e = [], t = 0; t < A.length; t++) {
            var i = A[t];
            i > 255 && (iA && d(!1, "Character code " + i + " (" + String.fromCharCode(i) + ")  at offset " + t + " not in 0x00-0xFF."),
            i &= 255),
    ...
    var nA = "function" == typeof atob ? atob : function(A) {
        var e, t, i, r, n, g, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", I = "", s = 0;
        A = A.replace(/[^A-Za-z0-9\+\/\=]/g, "");
        do {
            e = o.indexOf(A.charAt(s++)) << 2 | (r = o.indexOf(A.charAt(s++))) >> 4,
            t = (15 & r) << 4 | (n = o.indexOf(A.charAt(s++))) >> 2,
            i = (3 & n) << 6 | (g = o.indexOf(A.charAt(s++))),
            I += String.fromCharCode(e),
            64 !== n && (I += String.fromCharCode(t)),
            64 !== g && (I += String.fromCharCode(i))
        } while (s < A.length);
        return I
    }
    ;
    ...
    function CA(A) {
        ...
        A = A || g,
        Y > 0 || (N(),
        Y > 0 || (r.setStatus ? (r.setStatus("Running..."),
        setTimeout((function() {
            setTimeout((function() {
                r.setStatus("")
            }
        ...
        e.curve25519 = {
            ...
            sign: function(e, i) {
                var n = r._malloc(64)
                  ...
                  , I = (r._curve25519_sign(n, g, o, i.byteLength),
                new Uint8Array(64));
                return t(n, 64, I),
                r._free(n),
                r._free(g),
    ...
    function() {
        ...
        function t(A) {
            ...
            this.worker.onmessage = function(A) {
                ...
                A.data.error && "function" == typeof e.onerror ? e.onerror(new Error(A.data.error)) : "function" == typeof e.onsuccess && e.onsuccess(A.data.result),
 ...
 */
    ...
    fA = function() {
        ...
        function r(A, e) {
            var r, n, o;
            return e ? (o = 0 <= (A >>>= 0) && A < 256) && (n = i[A]) ? n : (r = g(A, (0 | A) < 0 ? -1 : 0, !0),
            o && (i[A] = r),
            r) : (o = -128 <= (A |= 0) && A < 128) && (n = t[A]) ? n : (r = g(A, A < 0 ? -1 : 0, !1),
            o && (t[A] = r),
            r)
        }
        function n(A, e) {
        ...
        d.add = function(A) {
            ...
            var t = this.high >>> 16
              ...
              , B = 0
              , C = 0;
            return B += (C += n + (65535 & A.low)) >>> 16,
            h += (B += r + f) >>> 16,
            a += (h += i + I) >>> 16,
            a += t + o,
            g((B &= 65535) << 16 | (C &= 65535), (a &= 65535) << 16 | (h &= 65535), this.unsigned)
        }
        ,
        ...
        d.multiply = function(A) {
            ...
            E += (u += o * f) >>> 16,
            E += t * h + i * a + r * f + o * I,
            g((Q &= 65535) << 16 | (c &= 65535), (E &= 65535) << 16 | (u &= 65535), this.unsigned)
        }
        ,
        d.mul = d.multiply,
        d.divide = function(A) {
            ...
            if (this.unsigned) {
                ...
                if (this.eq(y))
                    return A.eq(u) || A.eq(c) ? y : A.eq(y) ? u : (t = this.shr(1).div(A).shl(1)).eq(C) ? A.isNegative() ? u : c : (i = this.sub(A.mul(t)),
                    r = t.add(i.div(A)));
                if (A.eq(y))
                    return this.unsigned ? E : C;
                if (this.isNegative())
        ...
        d.shiftLeft = function(A) {
            return e(A) && (A = A.toInt()),
            0 == (A &= 63) ? this : A < 32 ? g(this.low << A, this.high << A | this.low >>> 32 - A, this.unsigned) : g(0, this.low << A - 32, this.unsigned)
        }
        ,
        d.shl = d.shiftLeft,
        d.shiftRight = function(A) {
            return e(A) && (A = A.toInt()),
            0 == (A &= 63) ? this : A < 32 ? g(this.low >>> A | this.high << 32 - A, this.high >> A, this.unsigned) : g(this.high >> A - 32, this.high >= 0 ? 0 : -1, this.unsigned)
        }
        ,
        d.shr = d.shiftRight,
    ...
    function(A) {
        ...
        function e(A) {
            var e = function(A, t, i) {
                if (void 0 === A && (A = e.DEFAULT_CAPACITY),
                void 0 === t && (t = e.DEFAULT_ENDIAN),
            ...
            function o() {
                ...
                return function() {
                    ...
                    A.length + arguments.length > 1024 && (e.push(n.apply(String, A)),
                    A.length = 0),
            ...
            e.concat = function(A, t, i, r) {
                ...
                for (var n, g = 0, o = 0, I = A.length; o < I; ++o)
                    e.isByteBuffer(A[o]) || (A[o] = e.wrap(A[o], t)),
                    (n = A[o].limit - A[o].offset) > 0 && (g += n);
                if (0 === g)
                    return new e(0,i,r);
                var s, f = new e(g,i,r), a = new Uint8Array(f.buffer);
                for (o = 0; o < I; )
                    (n = (s = A[o++]).limit - s.offset) <= 0 || (a.set(new Uint8Array(s.buffer).subarray(s.offset, s.limit), f.offset),
                    f.offset += n);
            ...
            e.wrap = function(A, r, n, g) {
                ...
                if (A instanceof Uint8Array)
                    ...
                    if ("[object Array]" !== Object.prototype.toString.call(A))
                        throw TypeError("Illegal buffer");
                    for ((o = new e(A.length,n,g)).limit = A.length,
                    i = 0; i < A.length; ++i)
            ...
            A && (t.writeInt64 = function(e, t) {
                ...
                t -= 8,
                this.littleEndian ? (this.view.setInt32(t, e.low, !0),
                this.view.setInt32(t + 4, e.high, !0)) : (this.view.setInt32(t, e.high, !1),
                this.view.setInt32(t + 4, e.low, !1)),
                i && (this.offset += 8),
                this
            }
            ,
            ...
            t.writeVarint32 = function(A, t) {
                ...
                return t > g && this.resize((g *= 2) > t ? g : t),
                t -= n,
                this.view.setUint8(t, r = 128 | A),
                (A >>>= 0) >= 128 ? (r = A >> 7 | 128,
                ...
                A >= 1 << 28 ? (this.view.setUint8(t + 4, A >> 28 & 15),
                n = 5) : (this.view.setUint8(t + 3, 127 & r),
                n = 4)) : (this.view.setUint8(t + 2, 127 & r),
                n = 3)) : (this.view.setUint8(t + 1, 127 & r),
                n = 2)) : (this.view.setUint8(t, 127 & r),
                n = 1),
                i ? (this.offset += n,
                this) : n
            }
            ...
            t.readVarint32ZigZag = function(A) {
                ...
                return "object" == typeof t ? t.value = e.zigZagDecode32(t.value) : t = e.zigZagDecode32(t),
                t
            }
            ,
            A && (e.MAX_VARINT64_BYTES = 10,
            ...
            e.zigZagEncode64 = function(e) {
                return "number" == typeof e ? e = A.fromNumber(e, !1) : "string" == typeof e ? e = A.fromString(e, !1) : !1 !== e.unsigned && (e = e.toSigned()),
                e.shiftLeft(1).xor(e.shiftRight(63)).toUnsigned()
            }
            ,
            e.zigZagDecode64 = function(e) {
                return "number" == typeof e ? e = A.fromNumber(e, !1) : "string" == typeof e ? e = A.fromString(e, !1) : !1 !== e.unsigned && (e = e.toSigned()),
                e.shiftRightUnsigned(1).xor(e.and(A.ONE).toSigned().negate()).toSigned()
            }
            ,
            ...
            t.readVarint64 = function(e) {
                ...
                var i = e
                  ...
                  , g = 0
                  , o = 0;
                if (r = 127 & (o = this.view.getUint8(e++)),
                128 & o && (r |= (127 & (o = this.view.getUint8(e++))) << 7,
                128 & o && (r |= (127 & (o = this.view.getUint8(e++))) << 14,
                128 & o && (r |= (127 & (o = this.view.getUint8(e++))) << 21,
                128 & o && (n = 127 & (o = this.view.getUint8(e++)),
                128 & o && (n |= (127 & (o = this.view.getUint8(e++))) << 7,
                128 & o && (n |= (127 & (o = this.view.getUint8(e++))) << 14,
                128 & o && (n |= (127 & (o = this.view.getUint8(e++))) << 21,
                128 & o && (g = 127 & (o = this.view.getUint8(e++)),
                128 & o && (g |= (127 & (o = this.view.getUint8(e++))) << 7,
                128 & o))))))))))
            ...
            t.readVarint64ZigZag = function(t) {
                ...
                return i && i.value instanceof A ? i.value = e.zigZagDecode64(i.value) : i = e.zigZagDecode64(i),
                i
            }
            ),
            t.writeCString = function(A, e) {
                ...
                return e > n && this.resize((n *= 2) > e ? n : e),
                e -= r + 1,
            ...
            t.readVString = function(A) {
                ...
                var t, i = this.readVarint32(A), r = A;
                A += i.length,
                i = i.value;
                var n = A + i
                  , g = o();
            ...
            t.append = function(A, t, i) {
                ...
                i += n;
                var g = this.buffer.byteLength;
                return i > g && this.resize((g *= 2) > i ? g : i),
                i -= n,
            ...
            t.compact = function(A, e) {
                ...
                !this.noAssert) {
                    ...
                    if (e >>>= 0,
                    A < 0 || A > e || e > this.buffer.byteLength)
                ...
                return new Uint8Array(i).set(new Uint8Array(this.buffer).subarray(A, e)),
                this.buffer = i,
            ...
            t.copy = function(A, t) {
                ...
                !this.noAssert) {
                    ...
                    "number" != typeof t || t % 1 != 0)
                        throw TypeError("Illegal end: Not an integer");
                    if (t >>>= 0,
                    A < 0 || A > t || t > this.buffer.byteLength)
                ...
                return r.offset = 0,
                r.limit = i,
                r.markedOffset >= 0 && (r.markedOffset -= A),
                this.copyTo(r, 0, A, t),
                r
            }
            ,
            t.copyTo = function(A, t, i, r) {
                ...
                if (t = (g = void 0 === t) ? A.offset : 0 | t,
                i = (n = void 0 === i) ? this.offset : 0 | i,
                r = void 0 === r ? this.limit : 0 | r,
                t < 0 || t > A.buffer.byteLength)
                ...
                var o = r - i;
                return 0 === o ? A : (A.ensureCapacity(t + o),
            ...
            ,
            t.LE = function(A) {
                return this.littleEndian = void 0 === A || !!A,
                this
            }
            ,
            t.BE = function(A) {
            ...
            t.prepend = function(A, t, i) {
                ...
                return g.set(new Uint8Array(A.buffer).subarray(A.offset, A.limit), i - n),
                A.offset = A.limit,
                r && (this.offset -= n),
                this
            }
            ...
            t.reverse = function(A, e) {
                ...
                return A === e || (Array.prototype.reverse.call(new Uint8Array(this.buffer).subarray(A, e)),
            ...
            t.toBuffer = function(A) {
                ...
                return new Uint8Array(n).set(new Uint8Array(this.buffer).subarray(e, t), 0),
                n
            }
            ,
            ...
            t.toString = function(A, e, t) {
                ...
                switch ("number" == typeof A && (t = e = A = "utf8"),
                A) {
                case "utf8":
            ...
            var I = function() {
                ...
                return A.encode = function(A, t) {
                    for (var i, r; null !== (i = A()); )
                        t(e[i >> 2 & 63]),
                        r = (3 & i) << 4,
                        null !== (i = A()) ? (t(e[63 & ((r |= i >> 4 & 15) | i >> 4 & 15)]),
                        r = (15 & i) << 2,
                        null !== (i = A()) ? (t(e[63 & (r | i >> 6 & 3)]),
                        t(e[63 & i])) : (t(e[63 & r]),
                        t(61))) : (t(e[63 & r]),
                        t(61),
                        t(61))
            ...
            t.toBinary = function(A, e) {
                ...
                for (var t = [], i = []; A < e; )
                    ...
                    t.length >= 1024 && (i.push(String.fromCharCode.apply(String, t)),
                    t = []);
            ...
            t.toDebug = function(A) {
                for (var e, t = -1, i = this.buffer.byteLength, r = "", n = "", g = ""; t < i; ) {
                    if (-1 !== t && (r += (e = this.view.getUint8(t)) < 16 ? "0" + e.toString(16).toUpperCase() : e.toString(16).toUpperCase(),
                    A && (n += e > 32 && e < 127 ? String.fromCharCode(e) : ".")),
                    ++t,
                    A && t > 0 && t % 16 == 0 && t !== i) {
                        for (; r.length < 51; )
                            r += " ";
            ...
            t.toHex = function(A, e) {
                ...
                for (var t, i = new Array(e - A); A < e; )
                    (t = this.view.getUint8(A++)) < 16 ? i.push("0", t.toString(16)) : i.push(t.toString(16));
                return i.join("")
            }
            ,
            e.fromHex = function(A, t, i) {
                ...
                for (var r, n = A.length, g = new e(n / 2 | 0,t), o = 0, I = 0; o < n; o += 2) {
                    if (r = parseInt(A.substring(o, o + 2), 16),
                    !i && (!isFinite(r) || r < 0 || r > 255))
            ...
            var s = function() {
                var A = {
                    ...
                    encodeUTF8: function(A, e) {
                        var t = null;
                        for ("number" == typeof A && (t = A,
                        A = function() {
                            return null
                        }
                        ); null !== t || null !== (t = A()); )
                            t < 128 ? e(127 & t) : t < 2048 ? (e(t >> 6 & 31 | 192),
                            e(63 & t | 128)) : t < 65536 ? (e(t >> 12 & 15 | 224),
                            e(t >> 6 & 63 | 128),
                            e(63 & t | 128)) : (e(t >> 18 & 7 | 240),
                            e(t >> 12 & 63 | 128),
                            e(t >> 6 & 63 | 128),
                            e(63 & t | 128)),
                            t = null
                    ...
                    decodeUTF8: function(A, e) {
                        for (var t, i, r, n, g = function(A) {
                            ...
                            if (0 == (128 & t))
                                ...
                                (null === (i = A()) || null === (r = A())) && g([t, i, r]),
                                e((15 & t) << 12 | (63 & i) << 6 | 63 & r);
                            else {
                                if (240 != (248 & t))
                                    throw RangeError("Illegal starting byte: " + t);
                                (null === (i = A()) || null === (r = A()) || null === (n = A())) && g([t, i, r, n]),
                                e((7 & t) << 18 | (63 & i) << 12 | (63 & r) << 6 | 63 & n)
                            }
                    },
                    UTF16toUTF8: function(A, e) {
                        for (var t, i = null; null !== (t = null !== i ? i : A()); )
                            t >= 55296 && t <= 57343 && null !== (i = A()) && i >= 56320 && i <= 57343 ? (e(1024 * (t - 55296) + i - 56320 + 65536),
                            i = null) : e(t);
                        null !== i && e(i)
                    },
                    UTF8toUTF16: function(A, e) {
                        ...
                        A = function() {
                            ...
                            t <= 65535 ? e(t) : (e(55296 + ((t -= 65536) >> 10)),
                            e(t % 1024 + 56320)),
                            t = null
                    },
 ...
 */
    function(A, e) {
        ...
        r.Util = ((i = {}).IS_NODE = !("object" != typeof A || A + "" != "[object process]" || A.browser),
        i.XHR = function() {
            for (var A = [function() {
        ...
        r.DotProto = function(A, e) {
            ...
            function s(A, e, t) {
                void 0 === A[e] ? A[e] = t : (Array.isArray(A[e]) || (A[e] = [A[e]]),
                A[e].push(t))
            }
                ...
                try {
                    for (; A = this.tn.next(); )
                        ...
                        case "import":
                            ...
                            ("public" === (A = this.tn.peek()) || (t = "weak" === A)) && this.tn.next(),
                            A = this._readString(),
                            this.tn.skip(";"),
                            t || i.imports.push(A);
                            break;
                    ...
                    throw A.message = "Parse error at line " + this.tn.line + ": " + A.message,
                    A
                }
            ...
            g._parseOptionValue = function(A, t) {
                var i = this.tn.peek();
                if ("{" !== i)
                    s(A.options, t, this._readValue(!0));
                else
            ...
            g._parseService = function(A) {
                ...
                for (this.tn.skip("{"); "}" !== (t = this.tn.next()); )
                    if ("option" === t)
                        this._parseOption(i);
                    else {
                        if ("rpc" !== t)
            ...
            g._parseServiceRPC = function(A) {
                ...
                if (this.tn.skip("("),
                "stream" === (t = this.tn.next()).toLowerCase() && (r.request_stream = !0,
                t = this.tn.next()),
                !e.TYPEREF.test(t))
                    throw Error("illegal rpc service request type: " + t);
                if (r.request = t,
                this.tn.skip(")"),
                "returns" !== (t = this.tn.next()).toLowerCase())
                    throw Error("illegal rpc service request type delimiter: " + t);
                if (this.tn.skip("("),
                "stream" === (t = this.tn.next()).toLowerCase() && (r.response_stream = !0,
                t = this.tn.next()),
                r.response = t,
                this.tn.skip(")"),
                "{" === (t = this.tn.peek())) {
                    for (this.tn.next(); "}" !== (t = this.tn.next()); ) {
                        if ("option" !== t)
            ...
            g._parseMessage = function(A, t) {
                ...
                t.id = o(this.tn.next()),
                n.isGroup = !0),
                "[" === (r = this.tn.peek()) && t && this._parseFieldOptions(t),
            ...
            g._parseMessageField = function(A, t, i) {
                ...
                if ("map" === t) {
                    ...
                    if (this.tn.skip("<"),
                    r = this.tn.next(),
                    !e.TYPE.test(r) && !e.TYPEREF.test(r))
                    ...
                    this.tn.skip("="),
                    n.id = o(this.tn.next()),
                    "[" === (r = this.tn.peek()) && this._parseFieldOptions(n),
                    this.tn.skip(";")
        ...
        r.Reflect = function(A) {
            var t = {}
              ...
              , r = i.prototype;
            r.fqn = function() {
                for (var A = this.name, e = this; null != (e = e.parent); )
                    A = e.name + "." + A;
                return A
            }
            ,
            ...
            g.getChildren = function(A) {
                ...
                for (var e = [], t = 0, i = this.children.length; t < i; ++t)
                    this.children[t]instanceof A && e.push(this.children[t]);
                return e
            }
            ,
            g.addChild = function(A) {
                ...
                if (e = this.getChild(A.name))
                    if (e instanceof f.Field && e.name !== e.originalName && null === this.getChild(e.originalName))
                        ...
                        if (!(A instanceof f.Field && A.name !== A.originalName && null === this.getChild(A.originalName)))
            ...
            g.resolve = function(A, e) {
                var i, r = "string" == typeof A ? A.split(".") : A, n = this, g = 0;
                if ("" === r[g]) {
                    for (; null !== n.parent; )
                        n = n.parent;
                    g++
            ...
            g.build = function() {
                for (var A, e = {}, t = this.children, i = 0, r = t.length; i < r; ++i)
                    (A = t[i])instanceof n && (e[A.name] = A.build());
            ...
            function s(e, t) {
                if (e && "number" == typeof e.low && "number" == typeof e.high && "boolean" == typeof e.unsigned && e.low == e.low && e.high == e.high)
                    return new A.Long(e.low,e.high,void 0 === t ? e.unsigned : t);
                if ("string" == typeof e)
                    return A.Long.fromString(e, t || !1, 10);
                if ("number" == typeof e)
                    return A.Long.fromNumber(e, t || !1);
                throw Error("not convertible to Long")
            }
            o.defaultFieldValue = function(t) {
                if ("string" == typeof t && (t = A.TYPES[t]),
            ...
            I.verifyValue = function(t) {
                ...
                case A.TYPES.sfixed32:
                    return ("number" != typeof t || t == t && t % 1 != 0) && r(typeof t, "not an integer"),
                    t > 4294967295 ? 0 | t : t;
                case A.TYPES.uint32:
                ...
                case A.TYPES.fixed64:
                    if (A.Long)
                        ...
                        r(typeof t, "requires Long.js");
                case A.TYPES.bool:
                    return "boolean" != typeof t && r(typeof t, "not a boolean"),
                    t;
                case A.TYPES.float:
                case A.TYPES.double:
                    return "number" != typeof t && r(typeof t, "not a number"),
                    t;
                case A.TYPES.string:
                    return "string" == typeof t || t && t instanceof String || r(typeof t, "not a string"),
                    "" + t;
                case A.TYPES.bytes:
                ...
                case A.TYPES.enum:
                    ...
                    if ("proto3" === this.syntax)
                        return ("number" != typeof t || t == t && t % 1 != 0) && r(typeof t, "not an integer"),
                        (t > 4294967295 || t < 0) && r(typeof t, "not in range for uint32"),
                        t;
                    r(t, "not a valid enum value");
                case A.TYPES.group:
                case A.TYPES.message:
                    if (t && "object" == typeof t || r(typeof t, "object expected"),
                    t instanceof this.resolvedType.clazz)
                        return t;
                    if (t instanceof A.Builder.Message) {
                        var g = {};
                        for (var o in t)
                            t.hasOwnProperty(o) && (g[o] = t[o]);
                        t = g
                    }
            ...
            I.calculateLength = function(t, i) {
                ...
                case A.TYPES.double:
                    return 8;
                case A.TYPES.string:
                    return r = e.calculateUTF8Bytes(i),
                    e.calculateVarint32(r) + r;
                case A.TYPES.bytes:
                    if (i.remaining() < 0)
            ...
            I.decode = function(e, t, i) {
                ...
                case A.TYPES.bytes:
                    if (n = e.readVarint32(),
                    e.remaining() < n)
                        throw Error("Illegal number of bytes for " + this.toString(!0) + ": " + n + " required but got only " + e.remaining());
                    return (r = e.clone()).limit = r.offset + n,
                    e.offset += n,
                    r;
                case A.TYPES.message:
                    return n = e.readVarint32(),
                    this.resolvedType.decode(e, n);
                case A.TYPES.group:
            ...
            a.build = function(t) {
                ...
                var i = function(A, t) {
                    var i = t.getChildren(A.Reflect.Message.Field)
                      ...
                      , n = function(g, o) {
                        ...
                        s = i.length; I < s; ++I) {
                            ...
                            !f.required && "proto3" !== t.syntax || null === f.defaultValue || (this[f.name] = f.defaultValue)
                        }
                        var a;
                        if (arguments.length > 0)
                            if (1 !== arguments.length || null === g || "object" != typeof g || !("function" != typeof g.encode || g instanceof n) || Array.isArray(g) || g instanceof A.Map || e.isByteBuffer(g) || g instanceof ArrayBuffer || A.Long && g instanceof A.Long)
                                ...
                                s = arguments.length; I < s; ++I)
                                    void 0 !== (a = arguments[I]) && this.$set(i[I].name, a);
                            else
                                this.$set(g)
                    }
                    ...
                    g.set = function(e, i, r) {
                        if (e && "object" == typeof e) {
                            for (var n in r = i,
                            e)
                                e.hasOwnProperty(n) && void 0 !== (i = e[n]) && this.$set(n, i, r);
                            return this
                        }
                        ...
                        if (r)
                            ...
                            if (!(g instanceof A.Reflect.Message.Field))
                                throw Error(this + "#" + e + " is not a field: " + g.toString(!0));
                            this[g.name] = i = g.verifyValue(i)
                        }
                        if (g && g.oneof) {
                            var o = this[g.oneof.name];
                            null !== i ? (null !== o && o !== g.name && (this[o] = null),
                            this[g.oneof.name] = g.name) : o === e && (this[g.oneof.name] = null)
                        }
                        return this
                    }
                    ,
                    ...
                    for (var o = 0; o < i.length; o++) {
                        ...
                        I instanceof A.Reflect.Message.ExtensionField || t.builder.options.populateAccessors && function(A) {
                            ...
                            var i = A.originalName.replace(/([A-Z])/g, (function(A) {
                              ...
                              , r = function(e, t) {
                                return this[A.name] = t ? e : A.verifyValue(e),
                                this
                            }
                              , n = function() {
                                return this[A.name]
                            };
                            null === t.getChild("set" + e) && (g["set" + e] = r),
                            null === t.getChild("set_" + i) && (g["set_" + i] = r),
                            null === t.getChild("get" + e) && (g["get" + e] = n),
                            null === t.getChild("get_" + i) && (g["get_" + i] = n)
                        }(I)
                    }
                    function s(t, i, r, n) {
                        ...
                        if (e.isByteBuffer(t))
                            return i ? t.toBase64() : t.toBuffer();
                        if (A.Long.isLong(t))
                            return r ? t.toString() : A.Long.fromValue(t);
                        var o;
                        if (Array.isArray(t))
                            return o = [],
                        ...
                        var a = t.$type
                          , h = void 0;
                        for (var B in t)
                            t.hasOwnProperty(B) && (a && (h = a.getChild(B)) ? o[B] = s(t[B], i, r, h.resolvedType) : o[B] = s(t[B], i, r));
                        return o
                    }
                    return g.encode = function(A, i) {
                        "boolean" == typeof A && (i = A,
                        A = void 0);
                        var r = !1;
                        A || (A = new e,
                        r = !0);
                    ...
                    n.decode = function(A, i, r) {
                        "string" == typeof i && (r = i,
                        i = -1),
                        "string" == typeof A && (A = e.wrap(A, r || "base64"));
                    ...
                    n.decodeDelimited = function(A, i) {
                        if ("string" == typeof A && (A = e.wrap(A, i || "base64")),
                        (A = e.isByteBuffer(A) ? A : e.wrap(A)).remaining() < 1)
                            return null;
                        var r = A.offset
                          , n = A.readVarint32();
                        if (A.remaining() < n)
                ...
                for (var r, n = 0, g = this.children.length; n < g; n++)
                    if ((r = this.children[n])instanceof u || r instanceof f || r instanceof l) {
                        ...
                        throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[n].toString(!0));
                return this.clazz = i
            }
            ,
            a.encode = function(A, e, t) {
                for (var i, r, n = null, g = 0, o = this._fields.length; g < o; ++g)
                    ...
                    i.required && null === r ? null === n && (n = i) : i.encode(t ? r : i.verifyValue(r), e, A);
                if (null !== n) {
            ...
            a.decode = function(e, t, i) {
                ...
                for (var r, n, g, o, I = e.offset, s = new this.clazz; e.offset < I + t || -1 === t && e.remaining() > 0; ) {
                    if (g = (r = e.readVarint32()) >>> 3,
                    (n = 7 & r) === A.WIRE_TYPES.ENDGROUP) {
                        if (g !== i)
                            throw Error("Illegal group end indicator for " + this.toString(!0) + ": " + g + " (" + (i ? i + " expected" : "not a group") + ")");
                        break
                    }
                    if (o = this._fieldsById[g]) {
                        ...
                        } else if (s[o.name] = o.decode(n, e),
                        o.oneof) {
                            var a = s[o.oneof.name];
                            null !== a && a !== o.name && (s[a] = null),
            ...
            var B = function(e, t, r, n, g, o, I, s, a, h) {
                ...
                !this.builder.options.convertFieldsToCamelCase || this instanceof f.ExtensionField || (this.name = A.Util.toCamelCase(this.name))
            }
              , C = B.prototype = Object.create(i.prototype);
            C.build = function() {
                this.element = new o(this.type,this.resolvedType,!1,this.syntax),
                this.map && (this.keyElement = new o(this.keyType,void 0,!0,this.syntax)),
                "proto3" !== this.syntax || this.repeated || this.map ? void 0 !== this.options.default && (this.defaultValue = this.verifyValue(this.options.default)) : this.defaultValue = o.defaultFieldValue(this.type)
            }
            ,
            C.verifyValue = function(e, t) {
                ...
                if (null === e)
                    return this.required && n(typeof e, "required"),
                    "proto3" === this.syntax && this.type !== A.TYPES.message && n(typeof e, "proto3 field without field presence cannot be null"),
                    null;
                if (this.repeated && !t) {
                    Array.isArray(e) || (e = [e]);
                    var g = [];
                ...
                return this.map && !t ? e instanceof A.Map ? e : (e instanceof Object || n(typeof e, "expected ProtoBuf.Map or raw object for map field"),
                new A.Map(this,e)) : (!this.repeated && Array.isArray(e) && n(typeof e, "no array expected"),
            ...
            C.encode = function(t, i, r) {
                ...
                try {
                    ...
                    if (this.repeated)
                        ...
                        this.map ? t.forEach((function(t, r, n) {
                        ...
                        ), this) : this.hasWirePresence(t, r) && (i.writeVarint32(this.id << 3 | this.type.wireType),
            ...
            C.calculate = function(t, i) {
                ...
                try {
                    ...
                    if (this.repeated)
                        if (this.options.packed && A.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                            for (r += e.calculateVarint32(this.id << 3 | A.WIRE_TYPES.LDELIM),
                            g = 0,
                            n = 0; n < t.length; n++)
                        ...
                        this.map ? t.forEach((function(t, i, n) {
                        ...
                        ), this) : this.hasWirePresence(t, i) && (r += e.calculateVarint32(this.id << 3 | this.type.wireType),
                        ...
                        !function(A) {
                            r[A.name] = function(i, r) {
                                try {
                                    ...
                                    i instanceof A.resolvedRequestType.clazz || (i = new A.resolvedRequestType.clazz(i)),
            ...
            return y.prototype = Object.create(w.prototype),
        ...
        r.Builder = function(A, e, t) {
            ...
            ,
            r.define = function(A) {
                if ("string" != typeof A || !e.TYPEREF.test(A))
                    throw Error("illegal namespace: " + A);
                return A.split(".").forEach((function(A) {
                    var e = this.ptr.getChild(A);
                    null === e && this.ptr.addChild(e = new t.Namespace(this,this.ptr,A)),
                    this.ptr = e
                }
                ), this),
                this
                ...
                for (var r = [e]; r.length > 0; ) {
                    ...
                    for (; e.length > 0; ) {
                        ...
                        if (i.isMessage(n)) {
                            ...
                            n.fields && n.fields.forEach((function(A) {
                                ...
                                var e = null;
                                if ("string" == typeof A.oneof && !(e = o[A.oneof]))
                            ...
                            n.extensions && ("number" == typeof n.extensions[0] ? g.extensions = [n.extensions] : g.extensions = n.extensions),
                            this.ptr.addChild(g),
                            I.length > 0) {
                                r.push(e),
                                e = I,
                            ...
                            if (g = this.ptr.resolve(n.ref, !0))
                                n.fields.forEach((function(e) {
                                    if (null !== g.getChild(0 | e.id))
            ...
            r.import = function(e, t) {
                ...
                if ("string" == typeof t) {
                    ...
                    var r = t.root;
                    A.Util.IS_NODE && (r = require("path").resolve(r)),
                    (r.indexOf("\\") >= 0 || t.file.indexOf("\\") >= 0) && (i = "\\");
                    var n = r + i + t.file;
                    if (!0 === this.files[n])
                        return this.reset();
                    this.files[n] = !0
                ...
                if (e.imports && e.imports.length > 0) {
                    ...
                    g = this.importRoot,
                    t = t.file,
                    (g.indexOf("\\") >= 0 || t.indexOf("\\") >= 0) && (i = "\\")) : "string" == typeof t ? this.importRoot ? g = this.importRoot : t.indexOf("/") >= 0 ? "" === (g = t.replace(/\/[^\/]*$/, "")) && (g = "/") : t.indexOf("\\") >= 0 ? (g = t.replace(/\\[^\\]*$/, ""),
                    i = "\\") : g = "." : g = null;
                    for (var I = 0; I < e.imports.length; I++)
                        if ("string" == typeof e.imports[I]) {
                            ...
                            var s = e.imports[I];
                            if ("google/protobuf/descriptor.proto" === s)
                                continue;
                            if (s = g + i + s,
                            !0 === this.files[s])
                                continue;
                            ...
                            t ? /\.(\w+)$/.test(t) ? this.import(e.imports[I], t.replace(/^(.+)\.(\w+)$/, (function(A, e, t) {
                                return e + "_import" + I + "." + t
                            }
                            ))) : this.import(e.imports[I], t + "_import" + I) : this.import(e.imports[I]);
                    o && (this.importRoot = null)
                }
                e.package && this.define(e.package),
                e.syntax && function A(e) {
                ...
                e.messages && (this.create(e.messages),
                this.ptr = a),
                e.enums && (this.create(e.enums),
                this.ptr = a),
                e.services && (this.create(e.services),
                this.ptr = a),
                e.extends && this.create(e.extends),
                this.reset()
            }
            ,
            r.resolveAll = function() {
                ...
                if (this.ptr instanceof t.Namespace)
                    ...
                    if (e.TYPE.test(this.ptr.type))
                        ...
                        if (!(i = (this.ptr instanceof t.Message.ExtensionField ? this.ptr.extension.parent : this.ptr.parent).resolve(this.ptr.type, !0)))
                    ...
                    if (!((i = this.ptr.parent.resolve(this.ptr.requestName, !0)) && i instanceof A.Reflect.Message))
                        throw Error("Illegal type reference in " + this.ptr.toString(!0) + ": " + this.ptr.requestName);
                    if (this.ptr.resolvedRequestType = i,
                    !((i = this.ptr.parent.resolve(this.ptr.responseName, !0)) && i instanceof A.Reflect.Message))
        ...
        r.Map = function(A, e) {
            var t = function(A, t) {
                ...
                if (this.field = A,
                this.keyElem = new e.Element(A.keyType,null,!0,A.syntax),
                this.valueElem = new e.Element(A.type,A.resolvedType,!1,A.syntax),
                this.map = {},
        ...
        r.loadProto = function(A, e, t) {
            return ("string" == typeof e || e && "string" == typeof e.file && "string" == typeof e.root) && (t = e,
            e = void 0),
            r.loadJson(r.DotProto.Parser.parse(A), e, t)
        }
        ,
        r.protoFromString = r.loadProto,
        r.loadProtoFile = function(A, e, t) {
            if (e && "object" == typeof e ? (t = e,
            e = null) : e && "function" == typeof e || (e = null),
            e)
                return r.Util.fetch("string" == typeof A ? A : A.root + "/" + A.file, (function(i) {
                    if (null !== i)
                        try {
        ...
        r.newBuilder = function(A) {
            return void 0 === (A = A || {}).convertFieldsToCamelCase && (A.convertFieldsToCamelCase = r.convertFieldsToCamelCase),
            void 0 === A.populateAccessors && (A.populateAccessors = r.populateAccessors),
            new r.Builder(A)
        }
        ,
    ...
    function() {
        "use strict";
        function A(A) {
            if (void 0 === A || !(A instanceof ArrayBuffer) || 32 != A.byteLength)
                throw new Error("Invalid private key")
        }
        function t(A) {
            if (void 0 === A || (33 != A.byteLength || 5 != new Uint8Array(A)[0]) && 32 != A.byteLength)
                throw new Error("Invalid public key");
            return 33 == A.byteLength ? A.slice(1) : (__LOG__(4)`libsignal: WARNING: Expected pubkey of length 33, please report the ST and client that generated the pubkey`,
            A)
        }
        function i(A) {
        ...
        function r(e) {
            return {
                ...
                Ed25519Verify: function(A, i, r) {
                    if (void 0 === (A = t(A)) || 32 != A.byteLength)
                        throw new Error("Invalid public key");
                    if (void 0 === i)
                        throw new Error("Invalid message");
                    if (void 0 === r || 64 != r.byteLength)
    ...
    function() {
        "use strict";
        var A = window.crypto;
        if (!A || !A.subtle || "function" != typeof A.getRandomValues)
            throw new Error("WebCrypto not found");
        e.crypto = {
            getRandomBytes: function(e) {
                var t = new Uint8Array(e);
                return A.getRandomValues(t),
                t.buffer
            },
            ...
            HKDF: function(A, t, i) {
                return e.crypto.sign(t, A).then((function(A) {
                    var t = new ArrayBuffer(i.byteLength + 1 + 32)
                      , r = new Uint8Array(t);
                    return r.set(new Uint8Array(i), 32),
                    r[r.length - 1] = 1,
                    e.crypto.sign(A, t.slice(32)).then((function(i) {
                        return r.set(new Uint8Array(i)),
                        r[r.length - 1] = 2,
                        e.crypto.sign(A, t).then((function(n) {
                            return r.set(new Uint8Array(n)),
                            r[r.length - 1] = 3,
                            e.crypto.sign(A, t).then((function(A) {
                                return [i, n, A]
                            }
                            ))
                        }
            ...
            createKeyPair: function(A) {
                return void 0 === A && (A = e.crypto.getRandomBytes(32)),
                e.Curve.async.createKeyPair(A)
            },
            ECDHE: function(A, t) {
    ...
    var QA = {
        ...
        generateSignedPreKey: function(A, t) {
            if (!(A.privKey instanceof ArrayBuffer && 32 == A.privKey.byteLength && A.pubKey instanceof ArrayBuffer && 33 == A.pubKey.byteLength))
    ...
    (e = e || {}).protobuf = function() {
        "use strict";
        var A = ("WhisperTextProtocol.proto",
        dcodeIO.ProtoBuf.loadProto(e.protoText["protos/WhisperTextProtocol.proto"]).build("textsecure"));
        return {
    ...
    e.SessionRecord = function() {
        ...
        var A = [{
            ...
            migrate: function(A) {
                ...
                if (A.registrationId)
                    for (e in t)
                        t[e].registrationId || (t[e].registrationId = A.registrationId);
                else
                    for (e in t)
                        -1 === t[e].indexInfo.closed && __LOG__(2)`libsignal: V1 session storage migration error: registrationId`
            }
        }]
          , t = function() {
            this.sessions = {},
        ...
        return t.initRecordFromData = function(e) {
            "v1" !== e.version && function(e) {
                for (var t = void 0 === e.version, i = 0; i < A.length; ++i)
                    t ? A[i].migrate(e) : A[i].version === e.version && (t = !0);
                if (!t)
                    throw new Error("Error migrating SessionRecord")
            }(e);
            var i = new t;
            if (i.sessions = e.sessions,
            void 0 === i.sessions || null === i.sessions || "object" != typeof i.sessions || Array.isArray(i.sessions))
        ...
        t.prototype = {
            ...
            getSessionByRemoteEphemeralKey: function(A) {
                ...
                var e, t = this.sessions, i = EA.toString(A);
                for (var r in t)
                    if (-1 == t[r].indexInfo.closed && (e = t[r]),
                    void 0 !== t[r][i])
                        return t[r];
                if (void 0 !== e)
                    return e
            ...
            getOpenSession: function() {
                var A = this.sessions;
                if (void 0 !== A)
                    for (var e in this.detectDuplicateOpenSessions(),
                    A)
                        if (-1 == A[e].indexInfo.closed)
                            return A[e]
            },
            ...
            getSessions: function() {
                ...
                for (var t in this.sessions)
                    -1 === this.sessions[t].indexInfo.closed ? A = this.sessions[t] : e.push(this.sessions[t]);
            ...
            archiveCurrentState: function() {
                var A = this.getOpenSession();
                void 0 !== A && (__LOG__(2)`libsignal: closing session`,
            ...
            removeOldChains: function(A) {
                for (; A.oldRatchetList.length > 10; ) {
                    for (var e = 0, t = A.oldRatchetList[0], i = 0; i < A.oldRatchetList.length; i++)
                        A.oldRatchetList[i].added < t.added && (t = A.oldRatchetList[i],
                        e = i);
            ...
            removeOldSessions: function() {
                for (var A, e, t = this.sessions; Object.keys(t).length > 40; ) {
                    for (var i in t) {
                        var r = t[i];
                        r.indexInfo.closed > -1 && (!e || r.indexInfo.closed < e.indexInfo.closed) && (A = i,
                        e = r)
                    }
        ...
        processPreKey: function(A) {
            return e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                return this.storage.isTrustedIdentity(this.remoteAddress.toString(), A.identityKey, this.storage.Direction.SENDING).then((function(t) {
                    ...
                    var t;
                    return A.preKey && (t = A.preKey.publicKey),
                    this.initSession(!0, e, void 0, A.identityKey, t, A.signedPreKey.publicKey, A.registrationId).then((function(t) {
                        return t.pendingPreKey = {
                            signedKeyId: A.signedPreKey.keyId,
                            baseKey: e.pubKey
                        },
                        A.preKey && (t.pendingPreKey.preKeyId = A.preKey.keyId),
                        t
                    }
                    ))
                }
                .bind(this)).then(function(A) {
                    ...
                    return this.storage.loadSession(t).then(function(i) {
                        var r;
                        return (r = void 0 !== i ? e.SessionRecord.initRecordFromData(i) : new e.SessionRecord).archiveCurrentState(),
                        r.updateSessionState(A),
                        Promise.all([this.storage.storeSession(t, r.prepareRecord()), this.storage.saveIdentity(this.remoteAddress.toString(), A.indexInfo.remoteIdentityKey)])
                    }
                    .bind(this))
                }
                .bind(this))
        ...
        processV3: function(A, e) {
            ...
            return this.storage.isTrustedIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer(), this.storage.Direction.RECEIVING).then(function(A) {
                if (!A) {
                    ...
                    throw r.identityKey = e.identityKey.toArrayBuffer(),
                    r
                }
            ...
            .bind(this)).then(function() {
                if (!(r = A.getSessionByBaseKey(e.baseKey))) {
                    if (r = A.getOpenSession(),
                    void 0 === i) {
                        if (void 0 !== r && void 0 !== r.currentRatchet)
                            return;
                        throw new Error("Missing Signed PreKey for PreKeyWhisperMessage")
                    }
                    return void 0 !== r && A.archiveCurrentState(),
                    e.preKeyId && !t && __LOG__(2)`libsignal: Invalid prekey id`,
                    this.initSession(!1, t, i, e.identityKey.toArrayBuffer(), e.baseKey.toArrayBuffer(), void 0, e.registrationId).then(function(t) {
                        return A.updateSessionState(t),
                        this.storage.saveIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer()).then((function() {
                            return e.preKeyId
                        }
                        ))
                    }
        ...
        initSession: function(A, t, i, r, n, g, o) {
            return this.storage.getIdentityKeyPair().then(function(I) {
                ...
                return Promise.all([e.crypto.ECDHE(g, I.privKey), e.crypto.ECDHE(r, i.privKey), e.crypto.ECDHE(g, i.privKey)]).then((function(i) {
                    if (A ? (s.set(new Uint8Array(i[0]), 32),
                    s.set(new Uint8Array(i[1]), 64)) : (s.set(new Uint8Array(i[0]), 64),
                    ...
                    return A ? (s.indexInfo.baseKey = t.pubKey,
                    s.indexInfo.baseKeyType = e.BaseKeyType.OURS,
                    e.crypto.createKeyPair().then(function(A) {
                        return s.currentRatchet.ephemeralKeyPair = A,
                        this.calculateSendingRatchet(s, g).then((function() {
                            return s
                        }
                        ))
                    }
                    .bind(this))) : (s.indexInfo.baseKey = n,
    ...
    wA.prototype = {
        ...
        encrypt: function(A, t) {
            return A = dcodeIO.ByteBuffer.wrap(A, t).toArrayBuffer(),
            e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                if (!(A instanceof ArrayBuffer))
                    throw new Error("Expected buffer to be an ArrayBuffer");
                var t, i, r, n, g, o = this.remoteAddress.toString(), I = new e.protobuf.WhisperMessage;
                return Promise.all([this.storage.getIdentityKeyPair(), this.storage.getLocalRegistrationId(), this.getRecord(o)]).then(function(A) {
                    ...
                    if (I.ephemeralKey = EA.toArrayBuffer(n.currentRatchet.ephemeralKeyPair.pubKey),
                    (g = n[EA.toString(I.ephemeralKey)]).chainType === e.ChainType.RECEIVING)
                ...
                .bind(this)).then((function() {
                    ...
                    return delete g.messageKeys[g.chainKey.counter],
                    I.counter = g.chainKey.counter,
                    I.previousCounter = n.currentRatchet.previousCounter,
                    e.crypto.encrypt(i[0], A, i[2].slice(0, 16)).then(function(A) {
                        I.ciphertext = A;
                        var g = I.toArrayBuffer()
                          , s = new Uint8Array(g.byteLength + 66 + 1);
                        return s.set(new Uint8Array(EA.toArrayBuffer(t.pubKey))),
                        s.set(new Uint8Array(EA.toArrayBuffer(n.indexInfo.remoteIdentityKey)), 33),
                        s[66] = 51,
                        s.set(new Uint8Array(g), 67),
                        e.crypto.sign(i[1], s.buffer).then(function(A) {
                            var e = new Uint8Array(g.byteLength + 9);
                            return e[0] = 51,
                            e.set(new Uint8Array(g), 1),
                            e.set(new Uint8Array(A,0,8), g.byteLength + 1),
                            this.storage.isTrustedIdentity(this.remoteAddress.toString(), EA.toArrayBuffer(n.indexInfo.remoteIdentityKey), this.storage.Direction.SENDING).then((function(A) {
                                if (!A)
                                    throw new Error("Identity key changed")
                            }
                            )).then(function() {
                            ...
                            .bind(this)).then(function() {
                                return r.updateSessionState(n),
                                this.storage.storeSession(o, r.prepareRecord()).then((function() {
                                    return e
                                }
                                ))
                            }
                ...
                .bind(this)).then((function(A) {
                    if (void 0 !== n.pendingPreKey) {
                        ...
                        return r.identityKey = EA.toArrayBuffer(t.pubKey),
                        r.registrationId = i,
                        r.baseKey = EA.toArrayBuffer(n.pendingPreKey.baseKey),
                        n.pendingPreKey.preKeyId && (r.preKeyId = n.pendingPreKey.preKeyId),
        ...
        decryptWithSessionList: function(A, e, t) {
            ...
            return this.doDecryptWhisperMessage(A, i).then((function(A) {
                ...
                return "MessageCounterError" === i.name ? Promise.reject(i) : (t.push(i),
                this.decryptWithSessionList(A, e, t))
            }
            .bind(this))
        },
            ...
            e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                ...
                return this.getRecord(e).then(function(t) {
                    ...
                    return this.decryptWithSessionList(A, t.getSessions(), []).then(function(A) {
                        return this.getRecord(e).then(function(t) {
                            return A.session.indexInfo.baseKey !== t.getOpenSession().indexInfo.baseKey && (t.archiveCurrentState(),
                            t.promoteState(A.session)),
                            this.storage.isTrustedIdentity(this.remoteAddress.getName(), EA.toArrayBuffer(A.session.indexInfo.remoteIdentityKey), this.storage.Direction.RECEIVING).then((function(A) {
                                if (!A)
                                    throw new Error("Identity key changed")
                            }
                            )).then(function() {
                            ...
                            .bind(this)).then(function() {
                                return t.updateSessionState(A.session),
                                this.storage.storeSession(e, t.prepareRecord()).then((function() {
                                    return A.plaintext
                                }
                                ))
                            }
            ...
            return e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                ...
                return this.getRecord(t).then(function(i) {
                    ...
                    return new lA(this.storage,this.remoteAddress).processV3(i, r).then(function(A) {
                        ...
                        return this.doDecryptWhisperMessage(r.message.toArrayBuffer(), e).then(function(r) {
                            return i.updateSessionState(e),
                            this.storage.storeSession(t, i.prepareRecord()).then(function() {
                                if (null != A)
        ...
        doDecryptWhisperMessage: function(A, t) {
            ...
            return void 0 === t ? Promise.reject(new Error("No session found to decrypt message from " + this.remoteAddress.toString())) : (-1 != t.indexInfo.closed && __LOG__(2)`libsignal: decrypting message for closed session`,
            this.maybeStepRatchet(t, o, g.previousCounter).then(function() {
                ...
                return this.fillMessageKeys(A, g.counter).then((function() {
                    ...
                    if (void 0 === t) {
                        ...
                        throw i.name = "MessageCounterError",
                        i
                    }
                    return delete A.messageKeys[g.counter],
                    e.HKDF(EA.toArrayBuffer(t), new ArrayBuffer(32), "WhisperMessageKeys")
                }
                ))
            }
            .bind(this)).then(function(A) {
                return this.storage.getIdentityKeyPair().then(function(i) {
                    ...
                    return g.set(new Uint8Array(EA.toArrayBuffer(t.indexInfo.remoteIdentityKey))),
                    g.set(new Uint8Array(EA.toArrayBuffer(i.pubKey)), 33),
                    g[66] = 51,
                    g.set(new Uint8Array(r), 67),
                    e.verifyMAC(g.buffer, A[1], n, 8)
                }
                .bind(this)).then((function() {
        ...
        fillMessageKeys: function(A, t) {
            ...
            if (t - A.chainKey.counter > 2e3)
                throw new Error("Over 2000 messages into the future!");
            if (void 0 === A.chainKey.key)
                throw new Error("Got invalid request to extend chain after it was already closed");
            var i = EA.toArrayBuffer(A.chainKey.key)
              , r = new Uint8Array(1);
            return r[0] = 1,
            e.crypto.sign(i, r.buffer).then(function(n) {
                return r[0] = 2,
                e.crypto.sign(i, r.buffer).then(function(e) {
                    return A.messageKeys[A.chainKey.counter + 1] = n,
                    A.chainKey.key = e,
                    A.chainKey.counter += 1,
                    this.fillMessageKeys(A, t)
                }
                .bind(this))
            }
            .bind(this))
        ...
        maybeStepRatchet: function(A, t, i) {
            ...
            .bind(this)).then(function() {
                return this.calculateRatchet(A, t, !1).then(function() {
                    ...
                    return void 0 !== A[i] && (r.previousCounter = A[i].chainKey.counter,
                    delete A[i]),
                    e.crypto.createKeyPair().then(function(e) {
                        return r.ephemeralKeyPair = e,
                        this.calculateRatchet(A, t, !0).then(function() {
        ...
        closeOpenSessionForDevice: function() {
            ...
            return e.SessionLock.queueJobForNumber(A, function() {
                return this.getRecord(A).then(function(e) {
                    if (void 0 !== e && void 0 !== e.getOpenSession())
                        return e.archiveCurrentState(),
                        this.storage.storeSession(A, e.prepareRecord())
                }
                .bind(this))
            }
            .bind(this))
    ...
    function() {
        function A(A, e) {
            for (var t = ((A[e] * Math.pow(2, 32) + A[e + 1] * Math.pow(2, 24) + A[e + 2] * Math.pow(2, 16) + A[e + 3] * Math.pow(2, 8) + A[e + 4]) % 1e5).toString(); t.length < 5; )
                t = "0" + t;
            return t
        }
        function t(t, i, r) {
            return function A(t, i, r) {
                return t = dcodeIO.ByteBuffer.concat([t, i]).toArrayBuffer(),
                e.crypto.hash(t).then((function(e) {
                    return 0 == --r ? e : A(e, i, r)
                }
                ))
            }(dcodeIO.ByteBuffer.concat([(0,
            new Uint16Array([0]).buffer), i, t]).toArrayBuffer(), i, r).then((function(e) {
        ...
        libsignal.FingerprintGenerator.prototype = {
            createFor: function(A, e, i, r) {
                if (!("string" == typeof A && "string" == typeof i && e instanceof ArrayBuffer && r instanceof ArrayBuffer))
    ...
    (e = e || {}).SenderKeyRecord = function() {
        ...
        A.prototype = {
            ...
            addSenderKeyState: function(A, e, t, i) {
                ...
                this.sessions.length > 5 && (this.sessions = this.sessions.slice(1))
            },
    ...
    yA.prototype = {
        process: function(A, e, t) {
            return e.addSenderKeyState(t.id, t.iteration, dcodeIO.ByteBuffer.wrap(t.chainKey).toArrayBuffer(), dcodeIO.ByteBuffer.wrap(t.signingKey).toArrayBuffer()),
            this.storage.storeSenderKey(A, e.prepareRecord())
        },
        create: function(A) {
            ...
            this.storage.storeSenderKey(t, A.prepareRecord()).then((function() {
                return g
            }
            ))
        }
    ...
    dA.prototype = {
        ...
        hkdkOutputToSymmetricMaterial(A, e) {
            ...
            return t.set(new Uint8Array(A.slice(16))),
        ...
        encrypt: function(A) {
            return A = dcodeIO.ByteBuffer.wrap(A).toArrayBuffer(),
            e.GroupSessionLock.queueJobForNumber(this.getSenderKeyName(), function() {
                return this.getRecord().then(function(t) {
                    ...
                    return this.fillMessageKeys(i, n).then(function() {
                        ...
                        e.HKDF(EA.toArrayBuffer(A), new ArrayBuffer(32), "WhisperGroup")
                    }
                    .bind(this)).then(function(n) {
                        ...
                        return e.crypto.encrypt(g.key, A, g.iv).then(function(A) {
                            ...
                            return e.crypto.Ed25519Sign(o, g.buffer).then(function(A) {
                                ...
                                this.storage.storeSenderKey(this.getSenderKeyName(), t.prepareRecord()).then((function() {
                                    return e
                                }
                                ))
                            }
                ...
                return this.getRecord().then(function(A) {
                    ...
                    return e.crypto.Ed25519Verify(new Uint8Array(i), new Uint8Array(n), new Uint8Array(g)).then(function() {
                        return this.fillMessageKeys(t, o.iteration).then(function() {
                            ...
                            return delete t.messageKeys[o.iteration],
                            e.HKDF(EA.toArrayBuffer(A), new ArrayBuffer(32), "WhisperGroup")
                        }
                        .bind(this)).then(function(A) {
        ...
        fillMessageKeys: function(A, t) {
            ...
            return r[0] = 1,
            e.crypto.sign(i, r.buffer).then(function(n) {
                return A.messageKeys[A.chainKey.counter] = n,
                r[0] = 2,
                e.crypto.sign(i, r.buffer).then(function(e) {
                    return A.chainKey.key = e,
                    A.chainKey.counter += 1,
                    this.fillMessageKeys(A, t)
                }
                .bind(this))
        ...
        createSenderKeyDistributionMsg: function() {
            ...
            return this.getRecord().then(function(t) {
                return t || (t = new e.SenderKeyRecord),
                A.create(t)
            }
            .bind(this))
        },
